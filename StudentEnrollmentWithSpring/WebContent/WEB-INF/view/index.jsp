...
<body>
	<div class="navbar navbar-default">
		...
		<div class="navbar-collapse collapse navbar-responsive-collapse">
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="signup/showForm">Signup</a></li>
				<li><a href="login/showForm">Login</a></li>
	...
	<div class="container">
		<div class="jumbotron">
			...
			<a class="btn btn-primary" href="signup/showForm">Signup » </a> <a
				class="btn btn-primary" href="login/showForm">Login » </a>
		</div>
